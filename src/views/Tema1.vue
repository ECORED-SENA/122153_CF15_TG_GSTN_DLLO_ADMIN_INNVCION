...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    SlyderF.mb-5.slyder-g(columnas="col-md-6 col-lg-4")
      .tarjeta.p-4.bg1
    ...
    .mb-5
      ...
      figcaption Video. Federico y las bases de datos
    ...
    .mx-auto.col-md-12.mb-43
      .titulo-sexto.color-acento-contenido
        p.mb-0 #[b Tabla 1.] Tipos, utilidad y tamaño de datos]
