      ...
      .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .row.justify-content-center.mb-4
          ...
          .col-lg-8
            TabsA.color-acento-contenido
              .tarjeta.color-acento-contenido-borde(titulo="Antes")
                .row
              ...
              .tarjeta.color-acento-contenido-borde(titulo="Durante")
                .row
                  .col-md-12.p-4.color-fondo
              ...
              .tarjeta.color-acento-contenido-borde(titulo="Después")
                .row
                  .col-md-12.p-4.color-fondo
              ...
              .tarjeta.color-acento-contenido-borde(titulo="Finalmente")
                .row
                  .col-md-12.p-4.color-fondo
              ...
              .tarjeta.color-acento-contenido-borde(titulo="Plan de <br> recuperación")
                .row
                  .col-md-12.p-4.color-fondo
        ...
        .row.justify-content-center.align-items-center.mb-5
          .col-lg-1.col-md-2.col-3
             img(src='@/assets/curso/temas/texto_destacado/img19.png', alt='') 
          .col-lg-9.col-md-9
